...
//    VoltageChart.clear();
    ...
    if (tTemp > (GRIDS_VERTICAL - 1)) {
        tTemp -= GRIDS_VERTICAL - 1;
    }
    sCompressionOffsetMillivolt = tTemp * tMillivoltPerGrid;

    VoltageChart.initYLabel(sCompressionOffsetMillivolt / 1000.0, tMillivoltPerGrid / 1000.0, sCompressionFactor / 1000.0, 3, 1); // 0.01 -> 100 for 1.0 (volt) , "3.5" as label
