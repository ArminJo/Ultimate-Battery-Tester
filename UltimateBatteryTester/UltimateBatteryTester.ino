...
#define LI_ION_SWITCH_OFF_VOLTAGE_MILLIVOLT        3400 // Switch off voltage for Li-ion capacity measurement
...
{ "Li-ion    ", 5000, 4100, LI_ION_SWITCH_OFF_VOLTAGE_MILLIVOLT/*3.45V*/, LI_ION_SWITCH_OFF_VOLTAGE_MILLIVOLT_LOW/*3V*/,
LOW_LOAD, 10 }, /*300 mA*/
